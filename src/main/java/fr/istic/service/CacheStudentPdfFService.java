...
public class CacheStudentPdfFService {
    ...
    public void uploadFile(org.jboss.resteasy.reactive.multipart.FileUpload file, long examId) {
         ...
         *
         * Collection<FormValue> inputParts = uploadForm.get("file");
         * for (FormValue inputPart : inputParts) {
         * try {
         * MultivaluedMap<String, String> header = inputPart.getHeaders();
         * fileName = getFileName(header);
         * fileNames.add(fileName);
         *
         * InputStream inputStream = inputPart.getFileItem().getInputStream();
         *
         * } catch (Exception e) {
         * e.printStackTrace();
         * }
